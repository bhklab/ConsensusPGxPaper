...
RecomputedIC50_Dist<-Distances_DrugTargets(results_RecomputedLNIC50_GRset,write.File=T,"Recomputed_IC50_DistanceToTargets_FDR10")
GDSC_IC50_Dist<-Distances_DrugTargets(results_GDSC_LNIC50_GRset,write.File=T,"GDSC_IC50_DistanceToTargets_FDR10")
GR50_Dist<-Distances_DrugTargets(results_LNGR50_GRset,write.File=T,"GR50_DistanceToTargets_FDR10")
RecomputedAUC_Dist<-Distances_DrugTargets(results_RecomputedAUC_GRset,write.File=T,"Recomputed_AUC_DistanceToTargets_FDR10")
GDSC_AUC_Dist<-Distances_DrugTargets(results_GDSC_AUC_GRset,write.File=T,"GDSC_AUC_DistanceToTargets_FDR10")
GRAOC_Dist<-Distances_DrugTargets(results_GRAOC_GRset,write.File=T,"GRAOC_DistanceToTargets_FDR10")
```
...
write.table(Drugs_Activities_combined,file="Calculated_Values/GDSC_240Drugs_AveragedResponses_Duplicates_June2018.txt",sep="\t",quote=FALSE,row.names=FALSE,col.names=FALSE,append=TRUE)
}
```
...
IC50_NDRset_Dist<-Distances_DrugTargets(results_IC50_NDRset,write.File=T,"IC50_NDRset_DistanceToTargets_FDR10")
GR50_NDRset_Dist<-Distances_DrugTargets(results_GR50_NDRset,write.File=T,"GR50_NDRset_DistanceToTargets_FDR10")
NDR50_NDRset_Dist<-Distances_DrugTargets(results_NDR50_NDRset,write.File=T,"NDR50_NDRset_DistanceToTargets_FDR10")
PI50_NDRset_Dist<-Distances_DrugTargets(results_PI50_NDRset,write.File=T,"PI50_NDRset_DistanceToTargets_FDR10")


AUC_NDRset_Dist<-Distances_DrugTargets(results_AUC_NDRset,write.File=T,"AUC_NDRset_DistanceToTargets_FDR10")
GRAOC_NDRset_Dist<-Distances_DrugTargets(results_GRAOC_NDRset,write.File=T,"GRAOC_NDRset_DistanceToTargets_FDR10")
NDRAOC_NDRset_Dist<-Distances_DrugTargets(results_NDRAOC_NDRset,write.File=T,"NDRAOC_NDRset_DistanceToTargets_FDR10")
PIAOC_NDRset_Dist<-Distances_DrugTargets(results_PIAOC_NDRset,write.File=T,"PIAOC_NDRset_DistanceToTargets_FDR10")
```
